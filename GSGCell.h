...
@property (nonatomic) CGPoint shapeCentrePointInView;                   //A coordinate for centre  point of shape in rect
@property (nonatomic) CGPoint centerOfViewInSuperView;                  //A coordinate for capturing the centre of the View
